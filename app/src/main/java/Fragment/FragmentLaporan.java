...
import Adapter.AdapterAdminLaporan;
...
public class FragmentLaporan extends Fragment {
    ...
    AdapterAdminLaporan adapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        final View view = inflater.inflate(R.layout.fragment_admin_laporan, container, false);
        ...
        adapter = new AdapterAdminLaporan(this.getActivity());
