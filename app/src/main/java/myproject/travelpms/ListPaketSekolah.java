...
public class ListPaketSekolah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_paket_sekolah);
        ...
        adapter = new AdapterListPaket(ListPaketSekolah.this,paketTourList);
        ...
        ref.child("pakettour").child(paketTour).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    new SweetAlertDialog(ListPaketSekolah.this, SweetAlertDialog.WARNING_TYPE)
                            .setTitleText("Data Kosong")
                            .setContentText("Tidak ada data paket sekolah")
                            .show();
