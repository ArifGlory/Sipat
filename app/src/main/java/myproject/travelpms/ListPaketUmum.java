...
public class ListPaketUmum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_paket_umum);
        ...
        ref.child("pakettour").child(paketTour).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    new SweetAlertDialog(ListPaketUmum.this, SweetAlertDialog.WARNING_TYPE)
                            .setTitleText("Data Kosong")
                            .setContentText("Tidak ada data paket umum")
                            .show();
